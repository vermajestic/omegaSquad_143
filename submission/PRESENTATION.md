# Project Presentation — Ocean Sentinel

## Presentation Link
- **Project Presentation Slides**: [View Presentation on Google Drive](https://drive.google.com/file/d/1dDokWenjOo_9_UtP0QbXfINCol6P7-w7/view?usp=sharing)

> [!NOTE]
> The presentation is hosted on Google Drive with public view access so evaluators can review the slides directly without download barriers or Git repository size bloat.
